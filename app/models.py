...
class Recipecontains(models.Model):
    iid = models.ForeignKey(Ingredient, models.DO_NOTHING)
...
class Recipes(models.Model):
    ...
    youtubevid = models.CharField(max_length=50, blank=True, null=True)
...
class Userrecipe(models.Model):
    ...
    uid = models.ForeignKey(AuthUser, models.DO_NOTHING, blank=True, null=True)
